...
namespace triqs {
  ...
  *-----------------------------------------------------------------------------------------------------*/
    ...
    template <typename RHS, typename M, typename T, typename L, typename OP> FORCEINLINE void clef_auto_assign(gf_view<M, T, L, OP> g, RHS const &rhs) {
    ...
    template <typename RHS, typename M, typename T, typename L, typename CP> FORCEINLINE void clef_auto_assign(gf<M, T, L, CP> &g, RHS const &rhs) {
      clef_auto_assign(g(), rhs);
    }

    // enable the writing g[om_] << .... also
    template <typename RHS, typename M, typename T, typename L, typename OP> FORCEINLINE void clef_auto_assign_subscript(gf_view<M, T, L, OP> g, RHS const &rhs) {
      clef_auto_assign(g, rhs);
    }
    ...
    template <typename RHS, typename M, typename T, typename L, typename CP> FORCEINLINE void clef_auto_assign_subscript(gf<M, T, L, CP> &g, RHS const &rhs) {
      clef_auto_assign(g, rhs);
    }
